                    ...
                    <tr>
                        <td style="padding:30px;color:#111827;font-size:15px;line-height:1.6;">
                            ...
                            <p style="margin:0 0 14px 0;">
                                Bonjour <strong>{{ $superviseurName }}</strong>,
                            </p>

                            <p style="margin:0 0 18px 0;">
                                Un incident vous a été <strong>assigné</strong> par
                                <strong>{{ $assignedByName }}</strong> pour suivi/validation.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:18px 0 8px 0;">
                                <tr>
                                    <td align="left">
                                        <span
                                            style="display:inline-block;padding:6px 10px;border-radius:999px;font-size:12px;font-weight:bold;background:#fef3c7;color:#92400e;">
                                            ⏳ {{ $statut }}
                                        </span>
                                        <span
                                            style="display:inline-block;margin-left:8px;padding:6px 10px;border-radius:999px;font-size:12px;font-weight:bold;background:#e0f2fe;color:#075985;">
                                            ⚠️ Sévérité: {{ $severite }}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:12px 0 0 0;font-size:13px;color:#6b7280;">
                                🔒 Les données sensibles ne sont pas incluses dans cet e-mail. Veuillez consulter la
                                plateforme.
                            </p>
